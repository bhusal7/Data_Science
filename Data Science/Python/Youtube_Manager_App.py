...
# #             <h4 style="color:#e50914;font-weight:bold;">{i}. {video['Video Name']}</h4>
# #             <p style="color:#f5f5f5;">⏱ Duration: {video['duration']}</p>
# #         </div>
...
# #         return
# #     index = st.selectbox("Choose video to update", range(len(videos)), format_func=lambda i: videos[i]["Video Name"])
# #     new_name = st.text_input("New Video Name", value=videos[index]["Video Name"])
# #     new_duration = st.text_input("New Duration", value=videos[index]["duration"])
# #     if st.button("Update"):
...
# #         return
# #     index = st.selectbox("Choose video to delete", range(len(videos)), format_func=lambda i: videos[i]["Video Name"])
# #     if st.button("Delete"):
# #         deleted = videos.pop(index)
# #         save_data_helper(videos)
# #         st.success(f"🗑️ Deleted video: {deleted['Video Name']}")
